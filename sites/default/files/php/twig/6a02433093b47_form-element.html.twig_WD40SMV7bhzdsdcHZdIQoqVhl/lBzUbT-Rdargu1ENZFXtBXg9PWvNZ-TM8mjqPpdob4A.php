...
class __TwigTemplate_70d8d4517c46e7825da76eb6c4cc96c5 extends Template
{
...
";
            ...
            // line 135
            yield "  <div";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null), ((!CoreExtension::inFilter(($context["type"] ?? null), ["date", "time"])) ? ("mb-3") : ("")), (((($tmp = ($context["float_label"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-floating") : (""))], "method", false, false, true, 135), "html", null, true);
            yield ">
    ";
            // line 136
            if (CoreExtension::inFilter(($context["label_display"] ?? null), ["before", "invisible"])) {
...
{% endif %}
", "themes/contrib/bootstrap/templates/form/form-element.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/hms/themes/contrib/bootstrap/templates/form/form-element.html.twig");
    }
